...
export default function MobileUserBottomNav({
  ...
  const items = [
    ...
    { href: "/dashboard/user/notifications?tab=unread", label: "Bildirim", Icon: Bell, key: "notifications", badge: unreadNotifications },
    { href: "/dashboard/user/messages", label: "Mesajlar", Icon: MessageSquare, key: "messages", badge: unreadMessages },
