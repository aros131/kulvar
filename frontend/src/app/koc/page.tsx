...
// ✅ API kökü (Render’daki mevcut backend’inle uyumlu)
...
export default function CoachesPage() {
  ...
  // URL’i senkron tut (q parametresi)
  useEffect(() => {
  ...
  // İlk yükleme ve URL’den gelen q ile listele
  useEffect(() => {
    let active = true;
    (async () => {
      setLoading(true);
...
async function fetchCoaches(
  ...
  try {
    // 1) Tercih edilen uç nokta: /coaches
    let url = `${API}/coaches`;
    ...
    // Veri şekli farklı olabilir; normalize edelim
